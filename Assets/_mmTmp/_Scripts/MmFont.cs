...
namespace mmfont.Net
{
    ...
    public static class MmFont
    {
        ...
        /// </summary>
        /// <param name="uniStr">Unicode string</param>
        /// <returns> Zawgyi string</returns>
        public static string Uni2Zg(string uniStr)
        {
            return Convert(UniRules, uniStr);
        }

        /// <summary>
        /// Convert Zawgyi to Unicode
        /// </summary>
        /// <param name="strZg">Zawgyi string</param>
        /// <returns>Unicode string</returns>
        public static string Zg2Uni(string strZg)
        {
            return Convert(ZGRules, strZg);
        }
